...
#
# Example:
#   ./getChecksums.sh kengine 2.7.5
#
# repo can be either kengine or xkengine, and version should be the raw semver,
# without a leading 'v'
# 
...
curl -sSL -o checksums.txt https://github.com/khulnasoft/${REPO}/releases/download/v${VERSION}/${REPO}_${VERSION}_checksums.txt
